    ...
    <article className="pt-16 pb-16">
      ...
      <div className="flex flex-col items-center gap-4 pt-8">
        <div className="container">
          ...
          <section className="max-w-[48rem] mx-auto mt-16 bg-brand-blue-500 text-white rounded-2xl shadow-floating-lg p-8 md:p-12 text-center">
            <h2 className="text-2xl md:text-3xl font-bold mb-3">
              Ready to grow your business online?
            </h2>
            <p className="text-blue-100 max-w-xl mx-auto mb-6">
              Free consultation, no pressure. Tell us about your business and where you want to take
              it.
            </p>
            <LeadCaptureModal
