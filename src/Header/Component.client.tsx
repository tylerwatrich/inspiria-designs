      ...
      <div className="flex justify-between">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <HeaderNav
            ...
            className={`absolute md:static left-0 right-0 bg-white dark:bg-gray-950 backdrop-blur-lg md:bg-transparent px-6 md:px-0 pt-2 md:pt-0 pb-4 md:pb-0 transition-all duration-300 z-40
